...
void config_ad(void)
{
    ...
    _SMPI = 4;    // AD1CON2<6:2> -- Every 9th conversion sent (number of channels sampled -1)
...
uint8_t LATC = 0x00; //IO expander
uint8_t LATD = 0x00; //LED bank
