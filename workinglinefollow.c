...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 11 17:27:47 2026
...
void config_pins_for_ad(void)
{
    ...
    TRISAbits.TRISA0 = 1; // Configure pin 2 for input MIDDLE
    TRISAbits.TRISA1 = 1; // Configure pin 3 for input RIGHT
    ...
    ANSAbits.ANSA0 = 1; // Configure pin 2 for analog MIDDLE
    ANSAbits.ANSA1 = 1; // Configure pin 3 for analog RIGHT
...
double goal = 2.27;//These are the midline values for each sensor mid sensor
...
double max_freq = 791;//This is the fastest we want the steppers to move
double min_freq = 80;//slowest
double std_freq = 436;
