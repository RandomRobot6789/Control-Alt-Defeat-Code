//This file has been edited by Andrew Jenkins from github.com/pololu/vl53l0x-arduino to make it a c file instead of c++
//and to not use the arduino libraries
...
bool init(struct sensor_instance* sensor, bool io_2v8); //had to remove default io_2v8 = true because this isn't c++
...
inline void setTimeout(struct sensor_instance* sensor, uint16_t timeout) { sensor->io_timeout = timeout; }
inline uint16_t getTimeout(struct sensor_instance* sensor) { return sensor->io_timeout; }
...
//These were declared static; I'm removing that
